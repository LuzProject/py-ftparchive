...
def log(message, color=colors['yellow'], nln=False):
	n = '\n'
	print(f'{n if nln else ""}' + colors['bold'] + colors['darkgrey'] + '[' + colors['reset'] + colors['bold'] + colors['green'] + '*' + colors['bold'] + colors['darkgrey'] + '] ' + colors['reset'] + f'{message}')
...
def error(message):
	print(colors['bold'] + colors['darkgrey'] + '[' + colors['reset'] + colors['bold'] + colors['lightred'] + '!' + colors['bold'] + colors['darkgrey'] + '] ' + colors['reset'] + f'{message}')
